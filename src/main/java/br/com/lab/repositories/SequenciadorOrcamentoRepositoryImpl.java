...
@Component
public class SequenciadorOrcamentoRepositoryImpl
    extends Repository<SequenciadorOrcamento, Long>
    implements SequenciadorOrcamentoRepository {
    ...
    public SequenciadorOrcamento getNext() {
        ...
        criteria.add(Restrictions.eq("data", new LocalDate()));
