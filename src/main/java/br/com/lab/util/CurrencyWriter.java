...
public class CurrencyWriter {
    ...
    /**
     * Nomes das grandezas numéricas no plural. O mapa a chave do mapa é o expoente de dez do
     * número e o valor é o seu nome no plural. Por exemplo: para chave 3 (10^3) o valor é "mil",
     * para a chave 6 (10^6) o valor é "milhões", e assim por diante. Os nomes foram obtidos de um
     * artigo publicado na seção Dois Mais Dois na revista SuperInteressante nº. 15, de dezembro de
     * 1988 (Editora Abril, São Paulo/SP), disponível em
    ...
    /**
     * O conversor reconhece números até a ordem dos setilhões, portanto, o maior valor suportado
     * atualmente é o representado abaixo.
     */
    ...
    public String write(final BigDecimal amount) {
        ...
        /*
         * TODO substituir o método setScale, abaixo, pela versão cujo parâmetro de arredondamento
         * é um enum
         */
        ...
        /*
         * Se o número estiver, digamos, na casa dos milhões, a pilha deverá conter 4 elementos
         * sendo os dois últimos os das centenas e dos centavos, respectivamente. Assim, o expoente
         * de dez que representa a grandeza no topo da pilha é o número de (elementos - 2) * 3
         */
    ...
    public String writeCapitalize(BigDecimal valor) {
        return capitalize(write(valor));
    }
